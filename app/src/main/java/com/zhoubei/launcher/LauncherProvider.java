...
import com.zhoubei.launcher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static final String DATABASE_NAME = "zhoubei_launcher.db";

    private static final int DATABASE_VERSION = 12;

    static final String AUTHORITY = "com.zhoubei.launcher.settings";
